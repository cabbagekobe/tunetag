...
// Genres maps an ID3v1 genre byte to its name. Indices 0-79 are the
// original ID3v1 genres; 80-191 are the Winamp extensions. Indices
// outside the table (192-254 and 255) return "" via GenreName.
var Genres = [...]string{
	...
	// Winamp extensions begin here (80).
